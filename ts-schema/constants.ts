...
export const Gpio = {
  ...
  VEHICLE_SENSOR_SPEED: 11, // GP11 - D_SPEED - pulse input from speed sensor
  THERMO_SENSOR_DATA: 12, // GP12 - D_SO
  THERMO_SENSOR_CS: 13, // GP13 - D_CS
  RESERVED_14: 14, // GP14 - RESERVED
  THROTTLE_SERVO_PWM: 15, // GP15 - D_SERVO_PWM - throttle servo pwm output
  SIGNAL_IN_LEFT: 16, // GP19 - D_SIG_L_IN
  SIGNAL_OUT_LEFT: 17, // GP16 - D_SIG_L_OUT
  SIGNAL_IN_RIGHT: 18, // GP18 - D_SIG_R_IN
  SIGNAL_OUT_RIGHT: 19, // GP17 - D_SIG_R_OUT
  ...
  VEHICLE_SENSOR_BATT: 26, // GP26 - ADC0 - D_VOLT - battery voltage input
  RESERVED_27: 27, // GP27 - ADC1 - RESERVED
  VEHICLE_SENSOR_THROTTLE: 28, // GP28 - ADC2 - D_HALL - primary Hall Sensor
